...
{
    public class RemoteSyslogSSLAppender : AppenderSkeleton, IDisposable
    {
        ...
        public RemoteSyslogSSLAppender()
        {
        ...
        public RemoteSyslogSSLAppender(string server, int port, string certificatePath)
            : this()
        {
            RemoteHost = server;
            RemotePort = port;
        ...
        public void Dispose()
        {
            try
            {
                LogDiagnosticInfo("RemoteSyslogSSLAppender.Dispose()");
